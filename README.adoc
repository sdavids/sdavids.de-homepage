...
----
.../sdavids.de-homepage/hp/node_modules/.bin/eslint: line 1: This: command not found
----

This build relies on https://esbuild.github.io[esbuild].
...
Or invoke esbuild's post-install script explicitly:
