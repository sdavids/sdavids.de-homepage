...
Add `httpd.local` to your `/etc/hosts`:

./etc/hosts
[source,shell]
----
127.0.0.1       localhost httpd.local
::1             localhost httpd.local
----
...
…
  "scripts": {
…
    "cert:copy": "scripts/copy-ca-based-cert.sh certs httpd.local",
    "cert:create": "scripts/create-ca-based-cert.sh certs 30 httpd.local",
    "cert:delete": "scripts/delete-ca-based-cert.sh certs httpd.local",
    "cert:renew": "scripts/renew-ca-based-cert.sh certs 30 httpd.local",
…
  },
…
----
